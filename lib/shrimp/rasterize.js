...
if (system.args.length < 3 || system.args.length > 11) {
  console.log('Usage: rasterize.js URL filename [paperwidth*paperheight|paperformat] [zoom] [margin] [orientation] [cookie_file] [render_time] [time_out] [source]');
  ...
  if( system.args[10] !== null && system.args[11] !== "" ){
    page.setContent( system.args[10], address );
    window.setTimeout(function(){
      page.render(output);
      phantom.exit();
    }, render_time );
